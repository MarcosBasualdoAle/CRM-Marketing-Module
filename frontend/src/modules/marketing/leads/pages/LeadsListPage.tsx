    ...
    return (
        <div className="space-y-6">
            ...
            <header className="flex justify-between items-center">
                ...
                {isAdmin && (
                    <div className="flex space-x-3">
                        ...
                        <Button variant="primary" onClick={() => navigate('/marketing/leads/new')}>
            ...
            <Tabs
                ...
                activeValue="list"
                onChange={(val) => val === 'import' && navigate('/marketing/leads/import')}
            />
            ...
            <div className="bg-white rounded-lg shadow-card border border-separator">
                ...
                <LeadTable
                    leads={leads}
                    isLoading={loading}
                    onViewDetail={(id) => navigate(`/marketing/leads/${id}`)}
