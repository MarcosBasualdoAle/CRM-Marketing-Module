    ...
    const loadLead = () => {
        if (id) {
            ...
            leadsApi.getById(Number(id))
                ...
                .catch(() => navigate('/marketing/leads'))
        ...
        <div className="space-y-6">
            ...
            <header className="flex justify-between items-center">
                ...
                <div className="flex space-x-3">
                    <Button variant="secondary" onClick={() => navigate('/marketing/leads')}>Volver</Button>
                </div>
            </header>
            ...
            <Modal
                ...
                onConfirm={async () => {
                    ...
                    if (result.success) {
                        navigate('/marketing/leads'); // Volver al listado tras borrar
                    } else {
                        alert('Error: ' + result.error);
