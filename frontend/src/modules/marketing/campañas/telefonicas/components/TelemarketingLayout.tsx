            ...
            <div className="flex flex-col h-full">
                ...
                {id && (
                    <nav className="mb-6 flex flex-wrap items-center gap-2 p-6 pb-0">
                        ...
                        <button
                            onClick={() => navigate(`/marketing/campanas/telefonicas/campanias/${id}/grabaciones`)}
                            className={getButtonClass(`/marketing/campanas/telefonicas/campanias/${id}/grabaciones`)}
                        >
                            Grabaciones
                        </button>
                    </nav>
