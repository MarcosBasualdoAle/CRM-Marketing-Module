            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-6 w-full sm:max-w-xl mx-auto">
                ...
                {onGenerateReport && (
                    <button
                        ...
                        className="flex min-w-[84px] cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full h-10 px-4 bg-green-600 text-white text-sm font-bold leading-normal tracking-wide shadow-sm hover:bg-green-700 transition-colors"
                    >
