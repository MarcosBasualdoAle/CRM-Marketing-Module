...
export const telemarketingApi = {
     ...
     */
    async getCampaignConfig(idCampania: number): Promise<any> {
        const response = await apiClient.get(`${BASE_URL}/campanias-telefonicas/${idCampania}/config`);
        return response.data.data;
    },
     ...
     */
    async updateCampaignConfig(idCampania: number, config: any): Promise<any> {
        const response = await apiClient.put(`${BASE_URL}/campanias-telefonicas/${idCampania}/config`, config);
        return response.data.data;
    }
};
