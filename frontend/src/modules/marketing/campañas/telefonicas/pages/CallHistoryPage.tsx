                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full">
                                    <thead className="bg-table-header">
                                        <tr>
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Fecha/hora</th>
                                            {!id && <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Campaña</th>}
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Lead</th>
                                            {id && <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Agente</th>}
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Teléfono</th>
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Resultado</th>
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Duración</th>
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Encuesta</th>
                                            <th className="p-4 text-sm font-semibold text-dark tracking-wide text-left">Acción</th>
                                        </tr>
                                    </thead>
