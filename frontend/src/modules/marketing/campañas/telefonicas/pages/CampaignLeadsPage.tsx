                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left">
                            <thead className="bg-gray-50 text-xs text-gray-600 uppercase">
                                <tr>
                                    <th className="px-4 py-3 font-semibold text-center">Nombre / Empresa</th>
                                    {!id && <th className="px-4 py-3 font-semibold text-center">Campaña</th>}
                                    <th className="px-4 py-3 font-semibold text-center">Teléfono</th>
                                    ...
                                    <th className="px-4 py-3 font-semibold text-center">Última llamada</th>
                                ...
                                {filteredContactos.map((contacto) => (
                                    ...
                                    >
                                        <td className="px-4 py-3 font-medium text-gray-900">
                                            <div className="whitespace-nowrap">{contacto.nombreCompleto}</div>
                                            <div className="text-gray-500 font-normal text-xs">{contacto.empresa}</div>
                                        </td>
                                        {!id && (
                                        ...
                                        <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{contacto.telefono}</td>
                                        <td className="px-4 py-3 text-gray-600">{contacto.email}</td>
                                        <td className="px-4 py-3 text-center">
                                            <span className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold ${getEstadoBadge(contacto.estadoCampania)}`}>
                                                {contacto.estadoCampania.replace('_', ' ')}
                                            </span>
                                        </td>
                                        <td className="px-4 py-3 text-center">
                                            <span className={`inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold ${getPrioridadBadge(contacto.prioridad)}`}>
                                                {contacto.prioridad}
                                            </span>
                                        </td>
                                        ...
                                        <td className="px-4 py-3 text-center">
                                            <button
                                                className="inline-flex items-center justify-center gap-1.5 rounded-full h-8 px-4 bg-primary text-white text-xs font-bold hover:bg-primary/90 transition-colors"
