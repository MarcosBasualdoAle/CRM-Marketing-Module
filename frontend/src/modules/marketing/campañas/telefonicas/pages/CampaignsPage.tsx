    ...
    const filteredCampanias = campanias
        .filter(c => {
            ...
            if (filters.searchTerm) {
                ...
                const matchesNombre = c.nombre.toLowerCase().includes(searchLower);
                const matchesCodigo = c.codigo.toLowerCase().includes(searchLower);
