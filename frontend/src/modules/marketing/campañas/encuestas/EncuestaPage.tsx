        ...
        <div className="space-y-6">
            ...
            <header className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-3">
                    <Button variant="primary" onClick={() => navigate('/marketing/encuestas/new')}>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        */}
                                                        <button
                                                            ...
                                                            onClick={() => navigate(`/marketing/encuestas/view/${encuesta.idEncuesta}`)}
                                                            title="Ver detalle"
                                                        >
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                if (encuesta.estado === 'BORRADOR') {
                                                                    navigate(`/marketing/encuestas/edit/${encuesta.idEncuesta}`);
                                                                }
                                                            }}
