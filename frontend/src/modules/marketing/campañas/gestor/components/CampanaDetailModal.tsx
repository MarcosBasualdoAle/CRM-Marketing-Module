...
import { CampaignConfigurationModal } from './CampaignConfigurationModal';
...
export const CampanaDetailModal: React.FC<CampanaDetailModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="card p-6">
                                    ...
                                    <div className="flex flex-col gap-3">
                                        {/* Configuración de Telemarketing - Only for telephone campaigns */}
                                        {campana.canalEjecucion === 'Llamadas' && (
                                            <button
            ...
            {campana && campana.canalEjecucion === 'Llamadas' && (
                <CampaignConfigurationModal
                    isOpen={configModalOpen}
                    onClose={() => setConfigModalOpen(false)}
                    campaignId={campana.idCampana}
                    onSuccess={() => {
                        refresh();
                        if (onUpdate) onUpdate();
                    }}
